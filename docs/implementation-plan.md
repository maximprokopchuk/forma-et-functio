...
| Монетизация | "Решить к v1" | **Freemium: FOUNDATIONS бесплатно, остальное $9/мес** | Валидировать гипотезу сразу |
...
|---|---|---|---|
| Designlab | менторство 1-на-1 | $800–7500, английский, sync | $10/мес, async, AI-грейдинг |
| IDF | огромная библиотека | скучный UI, слабые упражнения | интерактивные виджеты, современная вёрстка |
| Skillbox/BBE | рынок, маркетинг | $1500+, устаревшие примеры (Photoshop) | современный стек (Figma, Tailwind, OKLCH), на порядок дешевле |
...
**Killer-фичи**: интерактивные виджеты (§5), AI-грейдинг с rubric (§4), portfolio-generator (§4), дизайн **через призму реализации**.
...
**Freemium с первого дня** (валидируем гипотезу + собираем аудиторию):

- **Free**: весь FOUNDATIONS (15 тем), 1 interactive widget, AI chat (10 msg/day)
- **Pro ($9/мес)**: INTERFACE + EXPERIENCE + CRAFT, все widgets, AI chat (100 msg/day), submissions с AI feedback
- **Annual ($84/год)** — два месяца бесплатно

Stripe (или ЮKassa для RU). Paywall — soft (страница видна, CTA "upgrade").
...
- [ ] Freemium billing работает (Stripe или ЮKassa)
...
- **i18n таймлайн**: RU-launch в v1, EN — Q2 после validated demand?
